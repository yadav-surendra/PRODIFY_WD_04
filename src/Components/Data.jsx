...
export const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Surendra Prasad Yadav
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
         ...
         <p className="home__description">I'm creative react frontend developer based in Pokhara, Nepal and I'm very Passionate and dedicated to my work.
         </p>
